...
import { HiX, HiAcademicCap, HiUser, HiLocationMarker, HiCalendar, HiStatusOnline, HiOfficeBuilding } from 'react-icons/hi';
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-dark-700">
          <div className="flex items-center space-x-3">
            <div className="h-12 w-12 rounded-lg bg-purple-100 dark:bg-purple-900 flex items-center justify-center">
              <HiAcademicCap className="h-8 w-8 text-purple-600 dark:text-purple-400" />
            </div>
            <div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <span className="text-gray-900 dark:text-white font-medium">
                {department.program_count || 0} programs
              </span>
            </div>
          </div>
