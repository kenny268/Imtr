...
const CreateCourseModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleTextbookChange = (index, field, value) => {
    const newTextbooks = [...formData.textbooks];
    newTextbooks[index] = { ...newTextbooks[index], [field]: value };
    setFormData(prev => ({
      ...prev,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-dark-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-dark-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Add a new course to the system</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Prerequisites */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Prerequisites</h3>
          ...
          {/* Grading System */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Grading System</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => handleArrayInputChange('learning_objectives', e.target.value)}
                rows={4}
                className="w-full px-3 py-2 border border-gray-300 dark:border-dark-600 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent dark:bg-dark-700 dark:text-white"
          ...
          <div className="space-y-4">
            ...
            {formData.textbooks.map((textbook, index) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 border border-gray-200 dark:border-dark-700 rounded-lg">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Title *
                  </label>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleTextbookChange(index, 'author', e.target.value)}
                    required
                    className="w-full px-3 py-2 border border-gray-300 dark:border-dark-600 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent dark:bg-dark-700 dark:text-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={textbook.isbn}
                    onChange={(e) => handleTextbookChange(index, 'isbn', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-dark-600 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent dark:bg-dark-700 dark:text-white"
                  />
                </div>
            ...
            <button
              type="button"
              onClick={addTextbook}
              className="flex items-center space-x-2 px-4 py-2 text-brand-600 hover:text-brand-700 hover:bg-brand-50 dark:hover:bg-brand-900/20 rounded-lg transition-colors"
            >
              <HiX className="h-4 w-4 rotate-45" />
